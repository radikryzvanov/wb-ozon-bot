    ...
    messages: [
      { role: "system", content: SYSTEM_PROMPT },
      {
        ...
        content:
          ...
          "3. Продающий текст (2 коротких абзаца)\n4. Если товар — БАД/косметическое масло/продукт " +
          "с возможными противопоказаниями: короткий блок предупреждений (индивидуальная " +
          "непереносимость, консультация с врачом, беременность/кормление — по ситуации)\n" +
          "5. Блок SEO-ключевых слов и хештегов",
      },
    ],
  });
